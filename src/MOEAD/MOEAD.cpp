...
void MOEAD::mutation() {
    ...
    {
    case 0:
        swapNodeMutation(offspring);//save
        break;
    case 1:
        insertMutation(offspring);//save
        break;
    case 2:
        bitwiseMutation(offspring,0.2);//save
        break;
    case 3:
        shiftSubtreeMutation(offspring);//save
        break;
    case 4:
        swapBranchMutation(offspring);//save
        break;
    case 5:
        scrambleMutation(offspring);//nono
        break;
    case 6:
        swapSubtreeMutation(offspring);//nono
        break;
    case 7:
